...
import 'package:my_news_app/screens/view_all/view_all_business.dart';
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ReusableText(text: "Business"),
              InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewAllBusiness()));
                  },
                  child: ReusableText(
                    text: "View All",
                    size: 15,
